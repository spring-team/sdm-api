...
export interface ListenerRegistration {
    ...
    addUpdatedIssueListeners(...e: UpdatedIssueListener[]): any;
    /**
     * These are invoked when a goal reaches status "failure" or "success"
     * @param {GoalCompletionListener} e
     * @returns {this}
     */
    addGoalCompletionListeners(...e: GoalCompletionListener[]): any;
    addClosedIssueListeners(...e: ClosedIssueListener[]): this;
    addTagListeners(...e: TagListener[]): this;
    addChannelLinkListeners(...e: ChannelLinkListener[]): any;
    addBuildListeners(...e: BuildListener[]): any;
    /**
