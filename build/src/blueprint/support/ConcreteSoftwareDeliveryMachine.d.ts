 ...
 */
export declare class ConcreteSoftwareDeliveryMachine extends ListenerRegistrationSupport implements SoftwareDeliveryMachine {
    ...
    private addExtensionPack(configurer);
    /**
     ...
     */
    constructor(name: string, options: SoftwareDeliveryMachineOptions, configuration: Configuration, goalSetters: Array<GoalSetter | GoalSetter[]>);
}
