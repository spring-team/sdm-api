 ...
 */
export declare class SoftwareDeliveryMachineImpl extends ListenerRegistrationSupport implements SoftwareDeliveryMachine {
     ...
     */
    protected constructor(name: string, opts: SoftwareDeliveryMachineOptions);
}
