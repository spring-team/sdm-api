 ...
 */
let NoticeK8sTestDeployCompletionOnStatus = class NoticeK8sTestDeployCompletionOnStatus {
    /**
     *
    ...
    handle(event, ctx, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const id = new GitHubRepoRef_1.GitHubRepoRef(commit.repo.owner, commit.repo.name, commit.sha);
...
], NoticeK8sTestDeployCompletionOnStatus.prototype, "githubToken", void 0);
NoticeK8sTestDeployCompletionOnStatus = __decorate([
    automation_client_1.EventHandler("Request k8s deploy of linked artifact", graphQL_1.subscription({
        name: "OnAParticularStatus",
        variables: {
            context: RequestK8sDeploys_1.k8AutomationDeployContext(exports.K8sTestingDomain),
        }
    })),
    __metadata("design:paramtypes", [Goal_1.Goal,
        Goal_1.Goal])
], NoticeK8sTestDeployCompletionOnStatus);
exports.NoticeK8sTestDeployCompletionOnStatus = NoticeK8sTestDeployCompletionOnStatus;
//# sourceMappingURL=NoticeK8sDeployCompletion.js.map