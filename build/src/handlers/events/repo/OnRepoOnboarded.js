 ...
 */
let OnRepoOnboarded = class OnRepoOnboarded {
    ...
    handle(event, context, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const id = repoRef_1.toRemoteRepoRef(repoOnboarded.repo, { branch: repoOnboarded.repo.defaultBranch });
            const credentials = this.credentialsFactory.eventHandlerCredentials(context, id);
            const addressChannels = addressChannels_1.addressChannelsFor(repoOnboarded.repo, context);
...
OnRepoOnboarded = __decorate([
    automation_client_1.EventHandler("On repo onboarding", graphQL_1.subscription("OnRepoOnboarded")),
    __metadata("design:paramtypes", [Array, Object])
], OnRepoOnboarded);
exports.OnRepoOnboarded = OnRepoOnboarded;
//# sourceMappingURL=OnRepoOnboarded.js.map