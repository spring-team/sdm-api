 ...
 */
let OnPullRequest = class OnPullRequest {
    ...
    handle(event, context, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const id = repoRef_1.toRemoteRepoRef(repo, { sha: pullRequest.head.sha });
...
OnPullRequest = __decorate([
    automation_client_1.EventHandler("On pull request", graphQL_1.subscription("OnPullRequest")),
    __metadata("design:paramtypes", [Object, Array, Object])
], OnPullRequest);
exports.OnPullRequest = OnPullRequest;
//# sourceMappingURL=OnPullRequest.js.map