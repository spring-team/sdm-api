export declare type NeverMatch = null;
/**
 ...
 */
export declare type MappingResult<V> = Promise<V | undefined | NeverMatch>;
/**
 * Mapping function from F to V
 */
export declare type Mapper<F, V> = (from: F) => MappingResult<V>;
/**
...
export declare function isMapping(a: any): a is Mapping<any, any>;
