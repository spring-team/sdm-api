...
const commonPatterns_1 = require("../../../../src/common/command/support/commonPatterns");
describe("commonPatterns", () => {
    describe("SemVerRegExp", () => {
        it("should validate valid semantic versions", () => {
            ...
            vs.forEach(v => assert(commonPatterns_1.SemVerRegExp.pattern.test(v)));
        });
...
//# sourceMappingURL=commonPatternTest.js.map