...
const npmLogInterpreter_1 = require("../../../../../../../src/common/delivery/build/local/npm/npmLogInterpreter");
describe("NpmLogInterpreter", () => {
    it("should handle empty log", () => {
        const r = npmLogInterpreter_1.NpmLogInterpreter("");
        assert(!r);
    });
    it("should handle short failure log", () => {
        const r = npmLogInterpreter_1.NpmLogInterpreter(Fail1);
    ...
    it("should handle test failure", () => {
        const r = npmLogInterpreter_1.NpmLogInterpreter(Fail2);
        assert.equal(r.message, "Tests: 1 failing");
        assert.equal(r.relevantPart, RelevantPart2);
    });
    it("should handle general npm run failure", () => {
        const r = npmLogInterpreter_1.NpmLogInterpreter(Fail3);
...
ERROR: "compile" exited with 1.
\`\`\``;
//# sourceMappingURL=npmLogInterpreterTest.js.map