...
const leinBuilder_1 = require("../../../../../../../src/common/delivery/build/local/lein/leinBuilder");
describe("package.clj parsing", () => {
    it("should parse valid project.clj", () => __awaiter(this, void 0, void 0, function* () {
        const p = InMemoryProject_1.InMemoryProject.of(new InMemoryFile_1.InMemoryFile("project.clj", Valid1));
        const parsed = yield leinBuilder_1.projectCljToAppInfo(p);
...
//# sourceMappingURL=packageCljTest.js.map